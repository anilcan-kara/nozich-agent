# Streaming LLM Response Support for Nozich Agent
...
```
NOZICH_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("NOZICH_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `nozich_cli/config.py` | 1 | +streaming config defaults |
