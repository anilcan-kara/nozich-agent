"""AWS Bedrock Converse API adapter for Nozich Agent.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Nozich with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When Nozich is installed editable into system Python, the system boto3
