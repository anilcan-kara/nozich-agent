...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - nozich_home (str): The active NOZICH_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.nozich``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "nozich").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'nozich memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], nozich_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'nozich memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``nozich_home`` is the active NOZICH_HOME directory path.
