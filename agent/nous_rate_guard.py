...
(3 SDK retries x 3 Nozich retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_nozich_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".nozich")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Nozich, ...) behind one endpoint.  A 429 can mean either:
