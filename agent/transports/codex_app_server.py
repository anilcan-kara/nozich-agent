...
projection into Nozich' display, approval bridging, transcript projection into
...
"codex_app_server"`. Nozich' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("NOZICH_KANBAN_TASK"):
            kanban_db = spawn_env.get("NOZICH_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "NOZICH_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("NOZICH_HOME", os.path.expanduser("~/.nozich")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "nozich",
        client_title: str = "Nozich Agent",
