 ...
 *
 * A public install can end up with `origin=git@github.com:anilcan-kara/nozich-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/anilcan-kara/nozich-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/anilcan-kara/nozich-agent'
