...
cd apps/desktop
XCURSOR_SIZE=24 NOZICH_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/nozich-typing
# → /tmp/nozich-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/nozich-typing.before.heapsnapshot
# → /tmp/nozich-typing.after.heapsnapshot
```
