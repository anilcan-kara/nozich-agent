...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/nozich'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('nozich:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('nozich:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
