...
import type { SessionInfo } from '@/nozich'
 ...
 * e.g. `nozich-agent/desktop` vs `nozich-agent-wt-rtl/desktop`. Groups with a
...
export type WorktreeResolver = (cwd: string) => NozichWorktreeInfo | null | undefined
