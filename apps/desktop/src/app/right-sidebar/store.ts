...
const TAKEOVER_KEY = 'nozich.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Nozich can't clear via the API — the user
 *  sees exactly what runs instead of Nozich silently deleting their creds. */
