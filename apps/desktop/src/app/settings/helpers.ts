import type { NozichConfigRecord, ToolsetInfo } from '@/types/nozich'
...
export function getNested(obj: NozichConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: NozichConfigRecord, path: string, value: unknown): NozichConfigRecord {
...
function personalityOptions(config: NozichConfigRecord): string[] {
