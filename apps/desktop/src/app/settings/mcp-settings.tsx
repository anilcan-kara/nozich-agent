...
import { getNozichConfigRecord, type NozichGateway, saveNozichConfig } from '@/nozich'
...
function getServers(config: NozichConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveNozichConfig(nextConfig)
