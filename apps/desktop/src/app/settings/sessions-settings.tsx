...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/nozich'
...
// / Program Files), which buried any files Nozich wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.nozichDesktop` is
    ...
    const settings = window.nozichDesktop?.settings
