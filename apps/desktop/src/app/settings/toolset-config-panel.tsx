...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/nozich'
 ...
 * log inline — the GUI equivalent of the install step `nozich tools` runs
