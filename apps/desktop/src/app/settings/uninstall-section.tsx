...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Nozich agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the Nozich agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the Nozich agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Nozich agent, and all of your config, chats, secrets, and logs',
...
export function UninstallSection() {
  ...
  useEffect(() => {
    let alive = true
    const bridge = window.nozichDesktop?.uninstall
    if (!bridge) {
      setLoading(false)
      return
    }
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall Nozich</p>
