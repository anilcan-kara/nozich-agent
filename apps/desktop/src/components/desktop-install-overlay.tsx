 ...
 *
 * Renders the first-launch install progress for Nozich Agent. Mounted always;
...
export function DesktopInstallOverlay({ enabled = true }: DesktopInstallOverlayProps) {
  ...
  // there's no Nozich Agent installed yet and we can't drive install.sh
        ...
        <div className="w-full max-w-xl rounded-xl border border-(--stroke-nous) bg-card p-8 shadow-nous">
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <Button
                onClick={() => {
                  window.nozichDesktop?.openExternal?.(ups.docsUrl)
                }}
                size="sm"
                variant="ghost"
              >
            ...
            <div className="flex items-center justify-end">
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    await window.nozichDesktop?.cancelBootstrap?.()
                  } catch {
              ...
              <div className="flex gap-2">
                ...
                <Button
                  onClick={async () => {
                    ...
                    try {
                      await window.nozichDesktop?.resetBootstrap?.()
                    } catch {
