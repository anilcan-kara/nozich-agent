...
import { getGlobalModelOptions } from '@/nozich'
...
import type { ModelOptionProvider, OAuthProvider } from '@/types/nozich'
...
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/anilcan-kara/nozich-agent#bring-your-own-endpoint',
    placeholder: 'http://127.0.0.1:8000/v1'
  }
]

// Build the FULL API-key provider catalog from the backend model options so the
// onboarding / Providers key form lists every `api_key` provider `nozich model`
...
const SHOW_ALL_KEY = 'nozich-onboarding-show-all-v1'
