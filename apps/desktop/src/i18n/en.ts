...
export const en: Translations = {
  ...
  boot: {
    ready: 'Nozich Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Nozich settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingNozichDesktop: 'Starting Nozich Desktop…'
    },
    errors: {
      backgroundExited: 'Nozich background process exited.',
      backgroundExitedDuringStartup: 'Nozich background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Nozich backend is older than this desktop build and may not work correctly. Update to align them.',
    updateNozich: 'Update Nozich',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Nozich Desktop.',
    ...
    native: {
      ...
      inputBody: 'Nozich is waiting for your response.',
      turnDoneTitle: 'Nozich finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Nozich defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Nozich is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Nozich asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Nozich was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Nozich follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Nozich checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Nozich configuration...',
    ...
    gateway: {
      ...
      intro:
        'Nozich Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Nozich backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset NOZICH_DESKTOP_REMOTE_URL and NOZICH_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Nozich backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Nozich backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /nozich.',
      ...
      restartingMessage: 'Nozich Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Nozich ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Nozich runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Nozich desktop' },
    ...
    nozichActiveSessions: (version, count) => `Nozich ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@nozich:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Nozich environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Nozich will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Nozich...',
    placeholderReconnecting: 'Reconnecting to Nozich…',
    ...
    attachUrlDesc: 'Nozich will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Nozich can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Nozich from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Nozich will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Nozich updater will take over in its own window and reopen Nozich when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Nozich reconnects automatically when it’s back.',
    applyingClose: 'Nozich will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Nozich needs a one-time install',
    ...
    settingUpTitle: 'Setting up Nozich Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Nozich CLI or desktop instance is running. Stop any running Nozich instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Nozich installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Nozich Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Nozich is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Nozich…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Nozich',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Nozich at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Nozich connects automatically',
      loopback: 'Opens your browser to sign in — Nozich connects automatically',
    ...
    authorizeThere: 'Authorize Nozich there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Nozich there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Nozich inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Nozich will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Nozich is restarting...',
      askRestart: 'Ask Nozich to restart the server',
      lookingRestart: taskId => `Nozich is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Nozich is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Nozich finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Nozich could not restart the server.',
      stillWorking:
        'Nozich is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Nozich is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Nozich gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.nozich/config.yaml). Nozich won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Nozich needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Nozich needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Nozich Desktop to use Save Image.',
    restartToSaveImages: 'Restart Nozich Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `nozich gateway` running?'
    }
  },
