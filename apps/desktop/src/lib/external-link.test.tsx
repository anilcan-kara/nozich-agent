...
const desktopWindow = window as unknown as { nozichDesktop?: Window['nozichDesktop'] }
const initialNozichDesktop = desktopWindow.nozichDesktop

function installDesktopBridge(partial: Partial<Window['nozichDesktop']> = {}) {
  desktopWindow.nozichDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['nozichDesktop']
}
...
afterEach(() => {
  ...
  if (initialNozichDesktop) {
    desktopWindow.nozichDesktop = initialNozichDesktop
  } else {
    delete desktopWindow.nozichDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['nozichDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['nozichDesktop']['openExternal'] })
