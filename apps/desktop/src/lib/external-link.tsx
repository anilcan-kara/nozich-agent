...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|nozich):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.nozichDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.nozichDesktop?.openExternal?.(href)
  }
}
