...
import { getSessionMessages, listAllProfileSessions, listSessions } from './nozich'
...
describe('Nozich REST session helpers', () => {
  ...
  afterEach(() => {
    vi.restoreAllMocks()
    Reflect.deleteProperty(window, 'nozichDesktop')
  })
