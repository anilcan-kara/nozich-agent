...
Hooks are discovered from ~/.nozich/hooks/ directories, each containing:
...
HOOKS_DIR = get_nozich_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"nozich_hook_{hook_name}"
