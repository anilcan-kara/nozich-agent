...
Config: ~/.nozich/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.nozich/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_nozich_home()`` helper (NOZICH_HOME-aware and
...
RULES_FILE = get_nozich_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_nozich_home() / "feishu_comment_pairing.json"
