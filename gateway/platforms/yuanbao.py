...
try:
    ...
    _NOZICH_VERSION = "0.0.0"

_APP_VERSION = _NOZICH_VERSION
_BOT_VERSION = _NOZICH_VERSION
_YUANBAO_INSTANCE_ID = str(NOZICH_INSTANCE_ID)  # single source: yuanbao_proto.NOZICH_INSTANCE_ID
