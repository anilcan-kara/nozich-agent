#!/usr/bin/env python3
"""
SWE Runner with Nozich Trajectory Format

A runner that uses Nozich-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Nozich-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Nozich-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Nozich format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Nozich-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Nozich-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Nozich Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Nozich-Agent's built-in execution environments
    and outputs trajectories in Nozich-Agent format.
    """
    ...
    def _convert_to_nozich_format(
        ...
        """
        Convert internal message format to Nozich trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Nozich trajectory format
        trajectory = self._convert_to_nozich_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Nozich trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Nozich Trajectory Format")
    print("=" * 60)
