...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      nozichNpmLib = self'.packages.default.passthru.nozichNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. nozich-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Nozich Agent dev shell"
          ${combinedNonNpm}
          ${nozichNpmLib.mkNpmDevShellHook npmPackageJsonPaths fixLockfilesExe}
          echo "Ready. Run 'nozich' to start."
        '';
      };
    };
}
