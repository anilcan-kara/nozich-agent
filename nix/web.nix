# nix/web.nix — Nozich Web Dashboard (Vite/React) frontend build
{ pkgs, nozichNpmLib, ... }:
let
  npm = nozichNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "nozich-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../nozich_cli/web_dist for the
