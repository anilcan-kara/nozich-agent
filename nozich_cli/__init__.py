"""
Nozich CLI - Unified command-line interface for Nozich Agent.

Provides subcommands for:
- nozich chat          - Interactive chat (same as ./nozich)
- nozich gateway       - Run gateway in foreground
- nozich gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `nozich setup` on a fresh Pi.
    ...
    nozich_cli/stdio.py::configure_windows_stdio() runs later from the entry
