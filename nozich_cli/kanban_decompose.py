...
Invoked by ``nozich kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Nozich Agent board.
...
def _profile_author() -> str:
    """Mirror of ``nozich_cli.kanban._profile_author``."""
    return (
