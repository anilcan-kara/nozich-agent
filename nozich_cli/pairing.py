...
Usage:
    nozich pairing list              # Show all pending + approved users
    nozich pairing approve <platform> <code>  # Approve a pairing code
    nozich pairing revoke <platform> <user_id> # Revoke user access
    nozich pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle nozich pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: nozich pairing {list|approve|revoke|clear-pending}")
        print("Run 'nozich pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.nozich/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'nozich pairing list' to see pending codes.\n")
