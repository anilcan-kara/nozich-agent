...
Used by ``nozich profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``nozich_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Nozich Agent kanban board.
...
Rules:
  ...
  - Never write "Nozich Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_nozich_home())
        else:
