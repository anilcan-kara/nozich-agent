...
Entry point: ``nozich whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``nozich_cli/main.py``).
...
Nozich gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Nozich to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Nozich needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Nozich gateway in another terminal:")
    print("         nozich gateway")
    print()
    ...
    print()
    print("  Docs: https://nozich-agent.anilcan-kara.com/docs/user-guide/")
