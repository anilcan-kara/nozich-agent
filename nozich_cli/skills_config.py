"""
Skills configuration for Nozich Agent.
`nozich skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.nozich/config.yaml under:
...
from nozich_cli.config import cfg_get, load_config, save_config
from nozich_cli.colors import Colors, color
from nozich_cli.platforms import PLATFORMS as _PLATFORMS
