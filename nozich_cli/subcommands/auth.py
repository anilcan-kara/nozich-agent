...
def build_auth_parser(subparsers, *, cmd_auth: Callable) -> None:
    ...
    auth_spotify = auth_subparsers.add_parser(
        "spotify", help="Authenticate Nozich with Spotify via PKCE"
    )
    ...
    auth_spotify.add_argument(
        "--client-id", help="Spotify app client_id (or set NOZICH_SPOTIFY_CLIENT_ID)"
    )
    auth_spotify.add_argument(
        "--redirect-uri",
