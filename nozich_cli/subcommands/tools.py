"""``nozich tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'nozich tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # nozich tools list [--platform cli]
    ...
    # nozich tools disable <name...> [--platform cli]
    ...
    # nozich tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `nozich tools` runs after you pick a provider that\n"
