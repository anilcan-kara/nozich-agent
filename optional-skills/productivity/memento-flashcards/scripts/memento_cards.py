...
Data file: $NOZICH_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NOZICH_HOME = Path(os.environ.get("NOZICH_HOME", Path.home() / ".nozich"))
DATA_DIR = _NOZICH_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
