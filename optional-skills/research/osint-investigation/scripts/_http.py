...
DEFAULT_UA = (
    "nozich-osint-investigation/0.2 "
    "(+https://github.com/anilcan-kara/nozich-agent; "
    "set NOZICH_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("NOZICH_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
