...
12. **execute_code sandbox has no env vars** — When Nozich runs auto_jailbreak via execute_code, the sandbox doesn't inherit the Nozich `.env`. Load dotenv explicitly: `import os; from dotenv import load_dotenv; load_dotenv(os.path.join(os.environ.get("NOZICH_HOME", os.path.expanduser("~/.nozich")), ".env"))`
