# Nozich Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.nozich/plugins/nozich-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.nozich/plugins/nozich-achievements/scan_checkpoint.json`.
