# Nozich Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.nozich/plugins/nozich-achievements/state.json` (existing unlock state)
  - `~/.nozich/plugins/nozich-achievements/scan_snapshot.json` (new)
  - `~/.nozich/plugins/nozich-achievements/scan_checkpoint.json` (new)
