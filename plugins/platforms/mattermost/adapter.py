...
required — uses aiohttp which is already a Nozich dependency.
...
def interactive_setup() -> None:
    ...
    ``nozich_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Nozich delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # nozich_cli/setup.py::_setup_mattermost function.
