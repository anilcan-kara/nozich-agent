...
``_check_spotify_available()`` — when the user has not run ``nozich auth
spotify``, the tools remain registered (so they appear in ``nozich
...
The Spotify auth flow (``nozich auth spotify``), CLI plumbing, and docs
