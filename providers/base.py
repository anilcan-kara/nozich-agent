...
def _profile_user_agent() -> str:
    """Return a ``nozich-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from nozich_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"nozich-cli/{_ver}"
    except Exception:
        return "nozich-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # nozich-cli UA so the catalog endpoint is reachable.
