#!/usr/bin/env python3
"""Build the Nozich Model Catalog — a centralized JSON manifest of curated models.
...
Nozich CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Nozich release.
...
# Ensure NOZICH_HOME is set for imports that touch it at module level.
os.environ.setdefault("NOZICH_HOME", os.path.join(os.path.expanduser("~"), ".nozich"))

from nozich_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "nozich-agent repo",
            "docs": "https://nozich-agent.anilcan-kara.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
