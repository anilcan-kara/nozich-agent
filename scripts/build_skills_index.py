#!/usr/bin/env python3
"""Build the Nozich Skills Index — a centralized JSON catalog of all skills.
...
`nozich skills search/install` can use it without hitting the GitHub API.
...
# Ensure NOZICH_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Nozich Skills Index...", flush=True)
