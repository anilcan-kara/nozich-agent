...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Nozich\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@anilcan-kara.com",
    "cursoragent@cursor.com",
    "nozich@anilcan-kara.com",
    "nozich-audit@example.com",
    "nozich@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "anilcan-kara/nozich-agent",
                "--state", "merged",
