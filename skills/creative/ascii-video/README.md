...
Built for [Nozich Agent](https://github.com/anilcan-kara/nozich-agent). Usable in any coding agent. Canonical source lives here; synced to [`anilcan-kara/nozich-agent/skills/creative/ascii-video`](https://github.com/anilcan-kara/nozich-agent/tree/main/skills/creative/ascii-video) via PR.
