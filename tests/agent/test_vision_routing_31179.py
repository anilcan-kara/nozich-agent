...
def isolated_home(monkeypatch):
    """Temp NOZICH_HOME with config + clean credential env vars."""
    test_home = tempfile.mkdtemp(prefix="nozich_test_31179_")
    nozich_home = os.path.join(test_home, ".nozich")
    os.makedirs(nozich_home)
...
def _fresh_modules():
    """Drop cached nozich modules so each test reloads against current env."""
