...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("nozich_cli.config.get_config_path", return_value=config_path), \
             patch("nozich_cli.config.ensure_nozich_home"):
    ...
    def test_ensure_nozich_home_sets_0700(self):
        home = Path(self.tmpdir) / ".nozich"
        with patch("nozich_cli.config.get_nozich_home", return_value=home):
