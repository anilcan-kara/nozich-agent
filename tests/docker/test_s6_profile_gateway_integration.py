...
The unit tests in tests/nozich_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned nozich-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/nozich")
from nozich_cli.service_manager import S6ServiceManager
