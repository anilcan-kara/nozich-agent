...
def _fake_warning():
    return SimpleNamespace(
        message=(
            ...
            "openai/gpt-5.5-pro has known pricing above Nozich' safety threshold.\n"
...
def _setup_isolated_home(tmp_path, monkeypatch, *, warn):
    ...
    monkeypatch.setattr(
        "nozich_cli.model_switch.switch_model",
        lambda **kw: _fake_switch_result(),
    )
    monkeypatch.setattr("nozich_constants.get_nozich_home", lambda: nozich_home)
    monkeypatch.setattr("nozich_cli.config.get_nozich_home", lambda: nozich_home)
    monkeypatch.setattr(
