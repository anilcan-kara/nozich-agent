...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("NOZICH_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("NOZICH_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("NOZICH_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
