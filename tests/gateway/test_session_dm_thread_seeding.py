...
def store(tmp_path, monkeypatch):
    ...
    ~/.nozich/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at nozich_state import time, before pytest's NOZICH_HOME monkeypatch
    fires — the autouse fixture's NOZICH_HOME override doesn't help here.)
    """
    import nozich_state
