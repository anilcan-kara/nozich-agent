"""Tests for the specifier module + `nozich kanban specify` CLI surface.
...
from nozich_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `nozich kanban …` argparse surface directly."""
