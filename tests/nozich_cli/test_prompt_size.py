"""Tests for the ``nozich prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from nozich_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(nozich_home, memory_text="", user_text=""):
    mem_dir = nozich_home / "memories"
...
def _seed_skill(nozich_home, name, description):
    skill_dir = nozich_home / "skills" / "demo" / name
