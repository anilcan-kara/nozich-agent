"""Tests for the interactive session browser (`nozich sessions browse`).
...
from nozich_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """nozich sessions browse should be parseable."""
