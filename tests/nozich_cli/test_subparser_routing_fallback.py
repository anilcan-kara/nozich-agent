...
The main() function in nozich_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `nozich -c model`
...
def _build_parser():
    """Build a minimal replica of the nozich top-level parser."""
