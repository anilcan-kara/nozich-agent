...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from nozich_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in NOZICH_OVERLAYS
        overlay = NOZICH_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify nozich doctor recognizes Xiaomi env vars."""
