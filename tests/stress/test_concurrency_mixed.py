...
def worker_loop(worker_id: int, nozich_home: str, result_file: str) -> None:
...
def reclaimer_loop(nozich_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="nozich_mixed_stress_")
    print(f"NOZICH_HOME = {home}")
