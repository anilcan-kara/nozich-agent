...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "anilcan-kara.com"
...
def auth_json_path():
    """Return the Nozich auth store path, respecting NOZICH_HOME overrides."""
    return get_nozich_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`nozich tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from nozich_cli.auth import resolve_nous_access_token
