...
the get_anchored_view / get_messages_around primitives in nozich_state.
...
# Third-party integrations tag their sessions with NOZICH_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from nozich_state import DEFAULT_DB_PATH
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Nozich profile's database "
