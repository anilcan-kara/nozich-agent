...
Trust levels:
  - builtin:   Ships with Nozich. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.nozich/\.env|\~/\.nozich/\.env',
     "nozich_env_access", "critical", "exfiltration",
     "directly references Nozich secrets file"),
    ...
    (r'\.nozich/config\.yaml|\.nozich/SOUL\.md',
     "nozich_config_mod", "critical", "persistence",
     "references Nozich configuration files directly"),
...
# scan. `.skillignore` is the Nozich-native name; `.clawhubignore` is honored
