 ...
 *
 * Symptom: in `nozich --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@nozich/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using nozich --tui and as i type multiline my caret at the end will often ' +
