...
import type { ScrollBoxHandle } from '@nozich/ink'
import { evictInkCaches } from '@nozich/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.NOZICH_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
