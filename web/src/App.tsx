...
const SIDEBAR_COLLAPSED_KEY = "nozich-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="nozich-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="nozich-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const { activeAction, isBusy, isRunning, pendingAction, runAction } =
    useSystemActions();
  const canUpdateNozich = status?.can_update_nozich === true;
  ...
  if (canUpdateNozich) {
    items.push({
      action: "update",
      icon: Download,
      label: t.status.updateNozich,
      runningLabel: t.status.updatingNozich,
      spin: false,
    });
  }
