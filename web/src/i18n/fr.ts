...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateNozich: "Mettre à jour Nozich",
    updatingNozich: "Mise à jour de Nozich…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Nozich (parité avec `nozich plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.nozich/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.nozich/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.nozich/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Nozich Achievements",
      subtitle:
        "Badges Nozich à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Nozich en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Nozich davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Nozich détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Nozich analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Nozich Agent ☤",
    },
  },
  kanban: {
