...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateNozich: "Aggiorna Nozich",
    updatingNozich: "Aggiornamento di Nozich…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Nozich (parità con `nozich plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.nozich/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.nozich/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.nozich/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Nozich da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Nozich in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Nozich di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Nozich rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Nozich sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
