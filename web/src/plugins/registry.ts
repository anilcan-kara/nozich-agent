 ...
 *
 * Plugins call window.__NOZICH_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__NOZICH_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__NOZICH_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__NOZICH_PLUGIN_SDK__ = {
    ...
    // window.__NOZICH_SESSION_TOKEN__ directly.
    authedFetch,
