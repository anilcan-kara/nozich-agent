/**
 * Nozich Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__NOZICH_PLUGIN_SDK__`` and
 * ``window.__NOZICH_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__NOZICH_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``NozichPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@nozich/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__NOZICH_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__NOZICH_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__NOZICH_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface NozichPluginSDK {
...
declare global {
  interface Window {
    __NOZICH_PLUGIN_SDK__?: NozichPluginSDK;
    __NOZICH_PLUGINS__?: PluginRegistry;
  }
}
