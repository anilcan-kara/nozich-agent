 ...
 * `window.__NOZICH_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Nozich brand in the top bar
 ...
 *  `window.__NOZICH_PLUGINS__.registerSlot(...)`.
 *
