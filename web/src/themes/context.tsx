...
const STORAGE_KEY = "nozich-dashboard-theme";
...
const FONT_STORAGE_KEY = "nozich-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `nozich_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "nozich-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-nozich-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-nozich-theme-font", "true");
