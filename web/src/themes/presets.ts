 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `nozich_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Nozich Teal",
  description: "Classic dark teal — the canonical Nozich look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Nozich look, ported from the
 ...
 * nousnet-web's <body> is white; nozich-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Nozich Teal (Large)",
  description: "Nozich Teal with bigger fonts and roomier spacing",
