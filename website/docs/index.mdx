...
slug: /
sidebar_position: 0
title: "Nozich Agent Documentation"
...
The self-improving AI agent built by [Nous Research](https://anilcan-kara.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `nozich setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Nozich Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Nozich safely  |
| 🧭 **[Use MCP with Nozich](/guides/use-mcp-with-nozich)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Nozich](/guides/use-voice-mode-with-nozich)** | Hands-on setup and usage patterns for Nozich voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Nozich' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Nozich                              |
...
- **Built by model trainers** — Created by [Nous Research](https://anilcan-kara.com), the lab behind Nozich, Nomos, and Psyche. Works with [Nous Portal](https://portal.anilcan-kara.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://anilcan-kara.com) — the lab behind Nozich, Nomos, and Psyche models
