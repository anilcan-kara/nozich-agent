...
```bash
python3 -m pyfiglet "NOZICH" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=NOZICH&font=Slant" | boxes -d stone
```
