...
| | |
|---|---|
| Source | Optional — install with `nozich skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Nozich Agent |
| License | MIT |
...
The script reads `~/.nozich/.env` for two optional defaults:
...
Helper script: `~/.nozich/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.nozich/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.nozich/.env`.
...
```bash
python3 ~/.nozich/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.nozich/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
