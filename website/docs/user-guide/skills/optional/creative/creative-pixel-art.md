...
| | |
|---|---|
| Source | Optional — install with `nozich skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.nozich/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.nozich/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Nozich installs package this)
