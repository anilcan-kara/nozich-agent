...
| | |
|---|---|
| Source | Optional — install with `nozich skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Nozich Agent |
| License | MIT |
...
```
SCRIPT=~/.nozich/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.nozich/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
