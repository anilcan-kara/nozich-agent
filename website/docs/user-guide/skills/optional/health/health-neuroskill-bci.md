...
| | |
|---|---|
| Source | Optional — install with `nozich skills install official/health/neuroskill-bci` |
...
Connect Nozich to a running [NeuroSkill](https://neuroskill.com/) instance to read
