...
| | |
|---|---|
| Source | Optional — install with `nozich skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Nozich Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $NOZICH_OSINT_CACHE/icij/ (default: ~/.cache/nozich-osint/icij/).
...
# Set NOZICH_OSINT_UA=your-app/1.0 (your@email) to identify yourself
