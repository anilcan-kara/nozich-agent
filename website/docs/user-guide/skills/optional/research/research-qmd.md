...
| | |
|---|---|
| Source | Optional — install with `nozich skills install official/research/qmd` |
...
Nozich Agent via the native MCP client. This is the preferred
...
Then configure Nozich Agent to connect via HTTP:
