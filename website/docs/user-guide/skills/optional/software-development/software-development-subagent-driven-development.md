...
| | |
|---|---|
| Source | Optional — install with `nozich skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Nozich Agent (adapted from obra/superpowers) |
| License | MIT |
