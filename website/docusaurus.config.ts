...
const config: Config = {
  ...
  url: 'https://nozich-agent.anilcan-kara.com',
  baseUrl: '/docs/',

  organizationName: 'anilcan-kara',
  projectName: 'nozich-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/anilcan-kara/nozich-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/nozich-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://nozich-agent.anilcan-kara.com/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/anilcan-kara/nozich-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://github.com/anilcan-kara/nozich-agent' },
            { label: 'GitHub Issues', href: 'https://github.com/anilcan-kara/nozich-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://nozich-agent.anilcan-kara.com/' },
            { label: 'GitHub', href: 'https://github.com/anilcan-kara/nozich-agent' },
            { label: 'Nous Research', href: 'https://anilcan-kara.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://anilcan-kara.com">Nous Research</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
