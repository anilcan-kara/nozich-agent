#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Nozich docs site.
...
Both publish at:
  https://nozich-agent.anilcan-kara.com/docs/llms.txt
  https://nozich-agent.anilcan-kara.com/docs/llms-full.txt
...
SITE_BASE = "https://nozich-agent.anilcan-kara.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Nozich as a Python Library", None),
        ("guides/use-mcp-with-nozich", "Use MCP with Nozich", None),
        ("guides/use-voice-mode-with-nozich", "Use Voice Mode with Nozich", None),
        ("guides/use-soul-with-nozich", "Use SOUL.md with Nozich", None),
        ("guides/build-a-nozich-plugin", "Build a Nozich Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Nozich"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/anilcan-kara/"
        "nozich-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/anilcan-kara/nozich-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Nozich Agent — Full Documentation\n",
        (
            "This file is the entire Nozich Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Nozich, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://nozich-agent.anilcan-kara.com/docs\n",
        "Short index: https://nozich-agent.anilcan-kara.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
