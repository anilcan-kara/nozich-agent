  ...
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nozich-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-nozich-agent-skill-authoring',
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/optional/devops/devops-nozich-s6-container-supervision',
    ...
    },
    {
      ...
      items: [
        ...
        'guides/run-nozich-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-nozich',
        'guides/use-soul-with-nozich',
        'guides/use-voice-mode-with-nozich',
        'guides/build-a-nozich-plugin',
