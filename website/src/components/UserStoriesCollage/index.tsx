  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Nozich Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Nozich &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Nozich?{' '}
        <a
          href="https://github.com/anilcan-kara/nozich-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://github.com/anilcan-kara/nozich-agent" target="_blank" rel="noopener noreferrer">
